...
word_tags_list = []
ignore_words = ['?', '!',',','.', "'s", "'m"]
train_data_file = open('/content/C138/intents.json').read()
...
def create_bot_corpus(stem_words, classes):
    ...
    pickle.dump(stem_words, open('/content/C138/words.pkl','wb'))
    pickle.dump(classes, open('/content/C138/classes.pkl','wb'))
